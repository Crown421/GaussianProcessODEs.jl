...
#     initopt = Optim.optimize(sig -> -GaussianProcessODEs.initcost(sig, y, ker), sigma0)
...
#     tZ = y.u[1:end-1];
#     tker = GaussianProcessODEs.kernel(tZ, ker.kerneltype);
...
#     initker = GaussianProcessODEs.kernel(ker.Z, typeof(ker.kerneltype)(sigma))
#     initU = computeinitU(y, initker)
    
#     GaussianProcessODEs.loglpu(initU, initker)
# end
...
#     ker = GaussianProcessODEs.kernel(ker.Z, typeof(ker.kerneltype)(sigma))
#     npode = npODE(U, ker)
